...
func initHeatmap(countsByDay []types.CountByDay) templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_initHeatmap_f928`,
		Function: `function __templ_initHeatmap_f928(countsByDay){// let countsByDay = [
    ...
    paintHeatmap(getLightOrDarkTheme());   
		...
		Call:       templ.SafeScript(`__templ_initHeatmap_f928`, countsByDay),
		CallInline: templ.SafeScriptInline(`__templ_initHeatmap_f928`, countsByDay),
	}
}
