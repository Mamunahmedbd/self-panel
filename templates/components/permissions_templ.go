...
func initNotificationPermissions(componentID string, platforms map[domain.NotificationPlatform]bool, notifsPermissions types.NotificationPermissionsData) templ.ComponentScript {
    ...
    renderSvelteComponent("NotificationPermissions", componentID, {
		...
		Call:       templ.SafeScript(`__templ_initNotificationPermissions_4452`, componentID, platforms, notifsPermissions),
		CallInline: templ.SafeScriptInline(`__templ_initNotificationPermissions_4452`, componentID, platforms, notifsPermissions),
	}
}
