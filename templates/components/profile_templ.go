...
func initProfilePhotoUploaders(uploadProfilePicUrl, uploadGalleryPicUrl string, galleryPicsUploadEnabled bool) templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_initProfilePhotoUploaders_77ce`,
		Function: `function __templ_initProfilePhotoUploaders_77ce(uploadProfilePicUrl, uploadGalleryPicUrl, galleryPicsUploadEnabled){renderSvelteComponent('PhotoUploader', "edit-profile-pic", {
		...
		Call:       templ.SafeScript(`__templ_initProfilePhotoUploaders_77ce`, uploadProfilePicUrl, uploadGalleryPicUrl, galleryPicsUploadEnabled),
		CallInline: templ.SafeScriptInline(`__templ_initProfilePhotoUploaders_77ce`, uploadProfilePicUrl, uploadGalleryPicUrl, galleryPicsUploadEnabled),
	}
}
...
func initGalleryPhotoUploaders(uploadProfilePicUrl, uploadGalleryPicUrl string, galleryPicsUploadEnabled bool) templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_initGalleryPhotoUploaders_11c4`,
		Function: `function __templ_initGalleryPhotoUploaders_11c4(uploadProfilePicUrl, uploadGalleryPicUrl, galleryPicsUploadEnabled){renderSvelteComponent('PhotoUploader', "photo-uploader", {
		...
		Call:       templ.SafeScript(`__templ_initGalleryPhotoUploaders_11c4`, uploadProfilePicUrl, uploadGalleryPicUrl, galleryPicsUploadEnabled),
		CallInline: templ.SafeScriptInline(`__templ_initGalleryPhotoUploaders_11c4`, uploadProfilePicUrl, uploadGalleryPicUrl, galleryPicsUploadEnabled),
	}
}

func initCarousel() templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_initCarousel_44dc`,
		Function: `function __templ_initCarousel_44dc(){const swiper = new Swiper('.swiper', {
		// mousewheel: true,
		slidesPerView: 1,
		spaceBetween: 0,
		breakpoints: {
		...
		Call:       templ.SafeScript(`__templ_initCarousel_44dc`),
		CallInline: templ.SafeScriptInline(`__templ_initCarousel_44dc`),
	}
}
...
func ProfileHeader(page *controller.Page, profile *domain.Profile, isSelf, isPotentialMatch, isIndividualConvoView bool, uploadGalleryPicUrl, uploadProfilePicUrl string, galleryPicsMaxCount int) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if isSelf {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/components/profile.templ`, Line: 207, Col: 62}
			}
...
func InitPhoneNumberPicker(elementID, phoneE164, countryCode, saveEventName, formInputNameE164, formInputNameCountryCode string, disabled, readOnly bool) templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_InitPhoneNumberPicker_9725`,
		Function: `function __templ_InitPhoneNumberPicker_9725(elementID, phoneE164, countryCode, saveEventName, formInputNameE164, formInputNameCountryCode, disabled, readOnly){renderSvelteComponent('PhoneNumberPicker', elementID, {
		...
		Call:       templ.SafeScript(`__templ_InitPhoneNumberPicker_9725`, elementID, phoneE164, countryCode, saveEventName, formInputNameE164, formInputNameCountryCode, disabled, readOnly),
		CallInline: templ.SafeScriptInline(`__templ_InitPhoneNumberPicker_9725`, elementID, phoneE164, countryCode, saveEventName, formInputNameE164, formInputNameCountryCode, disabled, readOnly),
	}
}
