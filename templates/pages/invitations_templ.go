...
func initInvitationToastNotifications(id, textToCopy string) templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_initInvitationToastNotifications_3837`,
		Function: `function __templ_initInvitationToastNotifications_3837(id, textToCopy){// Function to copy text to clipboard
	...
	initClickListener();
		...
		Call:       templ.SafeScript(`__templ_initInvitationToastNotifications_3837`, id, textToCopy),
		CallInline: templ.SafeScriptInline(`__templ_initInvitationToastNotifications_3837`, id, textToCopy),
	}
}
