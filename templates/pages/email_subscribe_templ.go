...
func emailSubscribeJS(latitude, longitude float64) templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_emailSubscribeJS_4d87`,
		Function: `function __templ_emailSubscribeJS_4d87(latitude, longitude){var message = message | '';
	var map = map | null;
	...
	document.getElementById('subscribe-form-submit').addEventListener('click', function(event) {
		...
		Call:       templ.SafeScript(`__templ_emailSubscribeJS_4d87`, latitude, longitude),
		CallInline: templ.SafeScriptInline(`__templ_emailSubscribeJS_4d87`, latitude, longitude),
	}
}
